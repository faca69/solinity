...
export default function TokenNotFoundPage() {
  return (
    <div className="font-semibold flex flex-col items-center justify-center h-screen bg-clip-text text-transparent bg-gradient-to-b from-emerald-300 to-emerald-700">
