    ...
    <>
      ...
      <div className="py-60">
        <motion.h1
          ...
          text-6xl sm:text-7xl md:text-8xl lg:text-9xl xl:text-[200px] py-4
        "
        >
          Solinity
        </motion.h1>
        ...
        <motion.p
          ...
          viewport={{ once: true }}
          className="font-semibold text-lg sm:text-xl md:text-2xl lg:text-3xl xl:text-4xl
          bg-clip-text text-transparent bg-gradient-to-b from-gray-100 to-gray-300 mb-10"
        >
